# app/graphs/hybrid_vision_graph_mcp.py
...
def route_after_critic(state: HybridVisionState) -> str:
    if state.get("critic_decision") == "retry":
...
def build_hybrid_vision_graph_mcp(mcp_tools):
